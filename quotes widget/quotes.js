...
const authorProfessionElement = document.getElementById("author-profession");

function displayQuote(index) {
  const quoteObj = quotesArray[index];
  quoteElement.textContent = quoteObj.quote;
  authorProfessionElement.textContent = `${quoteObj.author} (${quoteObj.profession})`;
}
